  ...
  return (
    <div id='home'className='bg5 w-full min-h-screen text-center flex items-center '>
        <div className=' max-w-5xl m-auto md:grid grid-cols-2 gap-7  '>
            <div className='me max-w-5xl m-auto  justify-center  '>
            ...
            <ul  className='max-w-5xl m-auto pr-4 flex-col justify-center space-x-5 p-2'>
                ...
                <li><Socials/></li>
                <p className='  text-[#0f3b56] text-xl font-semibold pt-10 '>Etudiante developpeuse web fullstack </p>
                <h1 className='  font-semibold text-4xl tracking-normal text-[#0f3b56]  '>Elodie Guayroso</h1>
